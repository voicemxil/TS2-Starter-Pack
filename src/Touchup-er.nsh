...
WriteRegStr HKLM32 "Software\EA GAMES\The Sims 2 Fun with Pets Collection" "" ""
	...
	WriteRegStr HKLM32 "Software\Microsoft\Windows\CurrentVersion\Uninstall\The Sims 2 Starter Pack" "DisplayName" "The Sims 2 Starter Pack"
	WriteRegStr HKLM32 "Software\Microsoft\Windows\CurrentVersion\Uninstall\The Sims 2 Starter Pack" "FolderName" "$INSTDIR"
	WriteRegStr HKLM32 "Software\Microsoft\Windows\CurrentVersion\Uninstall\The Sims 2 Starter Pack" "UninstallString" "$\"$INSTDIR\Uninstall The Sims 2 Starter Pack.exe$\""
	WriteRegStr HKLM32 "Software\Microsoft\Windows\CurrentVersion\Uninstall\The Sims 2 Starter Pack" "DisplayIcon" "$\"$INSTDIR\${gameTitle}\TSBin\${gameEXE}$\""
	WriteRegStr HKLM32 "Software\Microsoft\Windows\CurrentVersion\Uninstall\The Sims 2 Starter Pack" "Publisher" "osab / EA"
!macroend