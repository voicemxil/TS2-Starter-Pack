...
- Downloads The Sims 2 Starter Pack (Ultimate Collection with Sims2RPC by Lazy Duchess included) & fixes from GitHub
...
- Automates Touchup process based on the install directory, includes fixes
