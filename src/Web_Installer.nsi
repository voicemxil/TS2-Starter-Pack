...
Section "TS2 Starter Pack" Section1
	...
	CreateDirectory "$INSTDIR\Language Selection"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Chinese_Simplified.reg" "$INSTDIR\Language Selection\Chinese_Simplified.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Chinese_Traditional.reg" "$INSTDIR\Language Selection\Chinese_Traditional.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Czech.reg" "$INSTDIR\Language Selection\Czech.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Dutch.reg" "$INSTDIR\Language Selection\Dutch.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/English_UK.reg" "$INSTDIR\Language Selection\English_UK.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Finnish.reg" "$INSTDIR\Language Selection\Finnish.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/French.reg" "$INSTDIR\Language Selection\French.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/German.reg" "$INSTDIR\Language Selection\German.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Greek.reg" "$INSTDIR\Language Selection\Greek.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Hebrew.reg" "$INSTDIR\Language Selection\Hebrew.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Hungarian.reg" "$INSTDIR\Language Selection\Hungarian.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Italian.reg" "$INSTDIR\Language Selection\Italian.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Japanese.reg" "$INSTDIR\Language Selection\Japanese.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Korean.reg" "$INSTDIR\Language Selection\Korean.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Norwegian.reg" "$INSTDIR\Language Selection\Norwegian.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Polish.reg" "$INSTDIR\Language Selection\Polish.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Portuguese_Brazil.reg" "$INSTDIR\Language Selection\Portuguese_Brazil.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Russian.reg" "$INSTDIR\Language Selection\Russian.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Spanish.reg" "$INSTDIR\Language Selection\Spanish.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Swedish.reg" "$INSTDIR\Language Selection\Swedish.reg"
	inetc::get /BANNER "Adding language selection files to game folder..." "https://raw.githubusercontent.com/voicemxil/TS2-Starter-Pack/main/components/language-selection/Thai.reg" "$INSTDIR\Language Selection\Thai.reg"	
